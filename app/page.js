...
export default async function Home() {
  ...
  return (
   ...
   <div className="bg-[#ddd] text-[16px] text-center rounded-xl md:w-[50%] secondAnimate sm:w-[85%] hover:bg-gray-200 mx-auto mt-36 py-2 hover:scale-110">
  ...
  {/* <Image className=' rounded-lg' src={service.img} width={25} height={25} alt='pic' /> */}
   ...
   <div className="bg-gray-200 w-full grid lg:grid-cols-10 md:grid-cols-5 sm:grid-cols-1  md:px-36 sm:px-10 gap-5 mt-16 py-16 secondAnimate">
